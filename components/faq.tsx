...
const FAQ: React.FC = () => {
    ...
    return (
        <section className="bg-green-100 text-black md:w-svw md:py-20 py-10 font-pathwayExtreme">
            <div className='w-full md:max-w-4xl mx-auto p-8 md:p-0'>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 justify-center">
                    <div className="mb-8 lg:col-span-1">
                        ...
                        <Button className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded mt-4">Visit Help Center</Button>
                    </div>
